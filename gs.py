            ...
            if i!=0:
                ...
                try:
                    ...
                    try:
                        ...
                        # print(i,' ',cn,' Rating: ',rating,' ',job,' ',location,' ',salary,'\n')
                        # print(job,"\n")

                    except:
                        print('opps')    
                    # print('company name:',company_name,' ',type(company_name),len(company_name))    
                    time.sleep(3)
                    try:
                        ...
                        try:
                            salary=driver.find_element_by_xpath('//body/div[3]/div[1]/div[1]/div[1]/div[1]/div[2]/section[1]/div[1]/div[1]/article[1]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]/div[1]/div[2]/div[1]').text.split()
                            # if salary[0]=='$':
                            #     sal=salary[-17:]
                            # else:
                            #     sal=salary[25:]    
                        except:
                            print('salery not found..')
                            salary='not found-------------------'
                    # print(i,'salary:',salary[25:],' ',type(salary),len(salary))    
                    try:
                    ...
                    # print(i,' ',cn,' Rating: ',rating,' ',job,' ',location,' ',sal,' ',jobtype[10:],'\n')  
